...
// EPD29G_128x296 (IL3820) commands very likely to SSD1608
enum reg3 {
    IL3820_DRIVER_CONTROL = 0x01,
    IL3820_GATE_VOLTAGE = 0x03,
    IL3820_SOURCE_VOLTAGE = 0x04,
    IL3820_DISPLAY_CONTROL = 0x07,
    IL3820_NON_OVERLAP = 0x0B,
    IL3820_BOOSTER_SOFT_START = 0x0C,
    IL3820_GATE_SCAN_START = 0x0F,
    IL3820_DEEP_SLEEP = 0x10,
    IL3820_DATA_MODE = 0x11,
    IL3820_SW_RESET = 0x12,
    IL3820_TEMP_WRITE = 0x1A,
    IL3820_TEMP_READ = 0x1B,
    IL3820_TEMP_CONTROL = 0x1C,
    IL3820_TEMP_LOAD = 0x1D,
    IL3820_MASTER_ACTIVATE = 0x20,
    IL3820_DISP_CTRL1 = 0x21,
    IL3820_DISP_CTRL2 = 0x22,
    IL3820_WRITE_RAM = 0x24,
    //IL3820_WRITE_ALTRAM = 0x26, //--
    IL3820_READ_RAM = 0x25,
    IL3820_VCOM_SENSE = 0x28,
    IL3820_VCOM_DURATION = 0x29,
    IL3820_PGM_VCOM_OTP = 0x2A, //+
    IL3820_WRITE_VCOM = 0x2C,
    IL3820_READ_OTP = 0x2D,
    IL3820_PGM_WS_OTP = 0x30, //++
    IL3820_WRITE_LUT = 0x32,
    IL3820_READ_LUT = 0x32, //++
    IL3820_PGM_OTP_SEL = 0x36, //++
    IL3820_OTP_SEL_CTRL = 0x37, //++
    IL3820_WRITE_DUMMY = 0x3A,
    IL3820_WRITE_GATELINE = 0x3B,
    IL3820_WRITE_BORDER = 0x3C,
    IL3820_SET_RAMXPOS = 0x44,
    IL3820_SET_RAMYPOS = 0x45,
    IL3820_SET_RAMXCOUNT = 0x4E,
    IL3820_SET_RAMYCOUNT = 0x4F,
    IL3820_NOP = 0xFF,
};
